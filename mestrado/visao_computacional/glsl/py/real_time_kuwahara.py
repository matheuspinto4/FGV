...
# Vertex and fragment shaders for rendering texture to screen
...
# Create window
window = glfw.create_window(1280, 720, "Real-Time Kuwahara Filter", None, None)
if not window:
    glfw.terminate()
...
# Set up quad for rendering (flipped y-axis in texCoord)
vertices = np.array([
    # Position   # TexCoord
...
glUniform1i(glGetUniformLocation(compute_program, "kernelSize"), kernel_size)
