...
with open("emboss_compute.glsl", "r") as f:
...
# Create window
window = glfw.create_window(1280, 720, "Real-Time Emboss Filter", None, None)
if not window:
    glfw.terminate()
...
intensity = 0.2  # Adjust for emboss strength
glUseProgram(compute_program)
glUniform1f(glGetUniformLocation(compute_program, "intensity"), intensity)
